...
public class GenerateReefPoses {
    ...
    public GenerateReefPoses() {
        ...
        for(int i = 0; i < 6; i++) {
            ...
            System.out.println("Theta: " + thetaConversion);
            Logger.recordOutput("Coral Right " + i, coralRightPositions[i]);
        }

        Logger.recordOutput("Algae pose 0", algaePositions[0]);
        // Logger.recordOutput("Algae pose 1", algaePositions[0]);
        Logger.recordOutput("Coral Left", coralLeftPositions[1]);
        Logger.recordOutput("Coral Right", coralRightPositions[2]);
